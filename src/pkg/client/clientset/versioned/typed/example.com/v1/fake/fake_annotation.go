...
func (c *FakeAnnotations) Get(name string, options v1.GetOptions) (result *example_com_v1.Annotation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(annotationsResource, c.ns, name), &example_com_v1.Annotation{})

	if obj == nil {
		return nil, err
	}
	return obj.(*example_com_v1.Annotation), err
}

// List takes label and field selectors, and returns the list of Annotations that match those selectors.
func (c *FakeAnnotations) List(opts v1.ListOptions) (result *example_com_v1.AnnotationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(annotationsResource, annotationsKind, c.ns, opts), &example_com_v1.AnnotationList{})
	...
	list := &example_com_v1.AnnotationList{}
	for _, item := range obj.(*example_com_v1.AnnotationList).Items {
...
func (c *FakeAnnotations) Create(annotation *example_com_v1.Annotation) (result *example_com_v1.Annotation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(annotationsResource, c.ns, annotation), &example_com_v1.Annotation{})
...
func (c *FakeAnnotations) Update(annotation *example_com_v1.Annotation) (result *example_com_v1.Annotation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(annotationsResource, c.ns, annotation), &example_com_v1.Annotation{})
...
func (c *FakeAnnotations) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(annotationsResource, c.ns, name), &example_com_v1.Annotation{})
...
func (c *FakeAnnotations) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &example_com_v1.AnnotationList{})
	return err
}

// Patch applies the patch and returns the patched annotation.
func (c *FakeAnnotations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *example_com_v1.Annotation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(annotationsResource, c.ns, name, data, subresources...), &example_com_v1.Annotation{})
